...
export const PHOTO_FILTERS: readonly PhotoFilter[] = [
  ...
  { id: 'warm', name: 'Warm', css: 'saturate(1.35) sepia(0.25) contrast(1.05) brightness(1.03)' },
  { id: 'cool', name: 'Cool', css: 'saturate(1.1) hue-rotate(-12deg) brightness(1.05) contrast(1.02)' },
  { id: 'bw', name: 'B&W', css: 'grayscale(1) contrast(1.1)' },
  { id: 'vintage', name: 'Vintage', css: 'sepia(0.45) saturate(1.2) contrast(0.95) brightness(1.05)' },
  { id: 'vivid', name: 'Vivid', css: 'saturate(1.6) contrast(1.15)' },
  { id: 'beauty', name: 'Beauty', css: 'brightness(1.12) saturate(1.05) contrast(0.96) blur(0.4px)' },
  { id: 'sepia', name: 'Sepia', css: 'sepia(0.7) brightness(1.05)' },
  { id: 'cinema', name: 'Cinema', css: 'contrast(1.2) saturate(0.85) brightness(0.95)' },
  { id: 'sunset', name: 'Sunset', css: 'sepia(0.35) saturate(1.4) hue-rotate(-18deg) brightness(1.05)' },
  { id: 'fresh', name: 'Fresh', css: 'brightness(1.1) saturate(1.25) hue-rotate(8deg)' },
  { id: 'noir', name: 'Noir', css: 'grayscale(1) sepia(0.3) brightness(1.05) contrast(1.1)' },
  { id: 'pop', name: 'Pop', css: 'saturate(1.8) contrast(1.1) brightness(1.05)' },
] as const;
