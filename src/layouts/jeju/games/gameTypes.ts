...
export type TouchGameId = 'spotdiff';
...
export interface MotionGameProps {
  ...
  runId: number;
  /**
   * The AI photo has landed. The display shows a quiet notice — the choice
   * itself is on the touch screen, which the player is not looking at.
   */
  photoReady?: boolean;
}
