...
export interface PlayerTrackingState {
  ...
  confidence: number;
  /**
   * The open hand / V-sign / fist the steering hand is holding, or null while it is in
   * between.
   *
   * Load-bearing for 제주 달리기, where a V-SIGN jumps and a FIST ducks. Classified per
   ...
   */
  gesture: 'open' | 'fist' | 'victory' | 'point' | null;
  /**
