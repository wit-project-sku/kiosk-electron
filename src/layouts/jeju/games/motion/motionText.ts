...
export const MOTION = {
  ...
  runDesc: {
    ko: '손을 올리면 점프, 주먹을 쥐면 숙이기!',
    en: 'Hand up to jump, make a fist to duck!',
    ja: '手を上げてジャンプ、グーでしゃがむ！',
    zh: '抬手跳跃，握拳低头！',
    vi: 'Giơ tay để nhảy, nắm tay để cúi!',
    th: 'ยกมือเพื่อกระโดด กำมือเพื่อหมอบ!',
    ru: 'Рука вверх — прыжок, кулак — пригнуться!',
    id: 'Angkat tangan untuk lompat, kepal untuk menunduk!',
  } as Str,
  runHowTo: {
    ko: '손을 올리면 점프, 주먹을 쥐면 숙여요',
    en: 'Hand up to jump, fist to duck',
    ja: '手を上げてジャンプ、グーでしゃがむ',
    zh: '抬手跳跃，握拳低头',
    vi: 'Giơ tay để nhảy, nắm tay để cúi',
    th: 'ยกมือเพื่อกระโดด กำมือเพื่อหมอบ',
    ru: 'Рука вверх — прыжок, кулак — пригнуться',
    id: 'Tangan naik lompat, kepal menunduk',
  } as Str,
  /**
   ...
   */
  runHoldStill: {
    ko: '손바닥을 펴서 앞에 들고 가만히 있어요',
    en: 'Hold your open hand up in front of you — keep still',
    ja: '手のひらを開いて前に上げ、そのまま動かないで',
    zh: '张开手掌举在前面，保持不动',
    vi: 'Xòe bàn tay giơ ra trước và giữ yên',
    th: 'แบมือยกไว้ข้างหน้าแล้วอยู่นิ่งๆ',
    ru: 'Поднимите открытую ладонь перед собой — не двигайтесь',
    id: 'Angkat telapak tangan terbuka di depan — tahan diam',
  } as Str,
  ...
  tutGoSub: {
    ko: '돌은 손 올리기 ⬆️  갈매기는 주먹 ✊',
    en: 'Rocks: hand up ⬆️  Gulls: fist ✊',
    ja: '石は手を上げる ⬆️  カモメはグー ✊',
    zh: '石头：抬手 ⬆️  海鸥：握拳 ✊',
    vi: 'Đá: giơ tay ⬆️  Chim: nắm tay ✊',
    th: 'หิน: ยกมือ ⬆️  นก: กำมือ ✊',
    ru: 'Камни: рука вверх ⬆️  Чайки: кулак ✊',
    id: 'Batu: angkat tangan ⬆️  Camar: kepal ✊',
  } as Str,
