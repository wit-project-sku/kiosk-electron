...
/**
 * 검색 (search) results — reached from the home search bar (Figma 인사>검색-02).
 * Searches the live shop catalogue (name · category · address · hashtag ·
 * description) via searchShops and lists matches; tapping one opens 상세.
 */
