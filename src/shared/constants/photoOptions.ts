...
/* Camera mount rotation is PER-VENUE, not a fleet constant: only the 제주
   kiosks mount their cameras sideways. See `cameraRotation` on kioskLocations
   (the short-lived fleet-wide `PHOTO_CAMERA_ROTATION` briefly lived here and
   rotated the upright Insadong/오색/화성 feeds too — reverted 2026-08-26). */
